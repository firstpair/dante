...
// cover/dante-commedia-cover.png (8.5in × 11in). The banner is images/dante-header.png.
...
#place(top + left, dx: 0.85in, dy: 3.4in)[
  ...
  #v(0.5in)
  #text(size: 16pt)[The Italian beside the English of]
  #v(0.05in)
  #text(size: 24pt)[Henry Wadsworth Longfellow]
  #v(0.25in)
